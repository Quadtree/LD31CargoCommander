...
void ALD31CargoCommanderPawn::FireShot(FVector FireDirection)
{
	...
	if (bCanFire == true)
	{
		...
		if (FireDirection.SizeSquared() > 0.0f)
		{
			...
			if (World != NULL)
			{
				...
				World->SpawnActor<ALD31CargoCommanderProjectile>(SpawnLocation, FireRotation);
			}

			bCanFire = false;
			World->GetTimerManager().SetTimer(this, &ALD31CargoCommanderPawn::ShotTimerExpired, FireRate);
...
void ALD31CargoCommanderPawn::ShotTimerExpired()
{
	bCanFire = true;
}
