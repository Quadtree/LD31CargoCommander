...
ALD31CargoCommanderProjectile::ALD31CargoCommanderProjectile(const FObjectInitializer& ObjectInitializer) 
	: Super(ObjectInitializer)
{
	...
	ProjectileMesh->OnComponentHit.AddDynamic(this, &ALD31CargoCommanderProjectile::OnHit);		// set up a notification for when this component hits something
...
void ALD31CargoCommanderProjectile::OnHit(AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
